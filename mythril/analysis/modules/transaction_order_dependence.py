...
class TODModule(DetectionModule):
    ...
    def _analyze_state(self, state: GlobalState):
        ...
        for call in calls:
            ...
            changing_sstores = list(self._get_influencing_sstores(state, interesting_storages))
    ...
    def _get_states_with_opcode(self, state, opcode):
    ...
    def _can_change(self, constraints, variable):
        ...
        try:
            ...
            return self._try_constraints(constraints, [variable != initial_value]) is not None
    ...
    def _get_influencing_sstores(self, statespace, interesting_storages):
        ...
        for sstore_state in self._get_states_with_opcode(statespace, 'SSTORE'):
